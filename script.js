const content = {
  en: {
    ...
    car2Desc: "Up to 8 passengers with large luggage space.",
  ...
  sv: {
    ...
    car2Title: "Premium Van",
    car2Desc: "Upp till 8 passagerare med stor bagagekapacitet.",
  ...
  es: {
    ...
    car2Desc: "Hasta 8 pasajeros con gran equipaje.",
  ...
  fr: {
    ...
    car2Title: "Van Premium",
    car2Desc: "Jusqu'à 8 passager avec bagages.",
  ...
  de: {
    ...
    car2Title: "Premium Van",
    car2Desc: "Bis 8 Personen, viel Platz.",
  ...
  it: {
    ...
    car2Title: "Van Premium",
    car2Desc: "Fino a 8 persone, ampio spazio.",

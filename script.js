...
const content = {
  en: {
    ...
    reviewsSubtitle: "We're just getting started - real reviews from our riders will appear here soon.",
    reviewsPlaceholderText: "Been a passenger with us? We'd love to hear about your trip.",
  ...
  sv: {
    ...
    reviewsSubtitle: "Vi har precis kommit igång - riktiga recensioner från våra resenärer dyker upp här snart.",
    reviewsPlaceholderText: "Har du åkt med oss? Vi vill gärna höra om din resa.",
  ...
  es: {
    ...
    reviewsSubtitle: "Acabamos de empezar - pronto aparecerán aquí reseñas reales de nuestros pasajeros.",
    reviewsPlaceholderText: "¿Has viajado con nosotros? Nos encantaría saber sobre tu viaje.",
  ...
  fr: {
    ...
    reviewsSubtitle: "Nous démarrons tout juste - de vrais avis de nos passagers apparaîtront bientôt ici.",
    reviewsPlaceholderText: "Vous avez déjà voyagé avec nous ? Nous aimerions avoir votre avis sur votre trajet.",
  ...
  de: {
    ...
    reviewsSubtitle: "Wir stehen noch am Anfang - echte Bewertungen unserer Fahrgäste erscheinen hier bald.",
    reviewsPlaceholderText: "Sind Sie schon mit uns gefahren? Wir würden uns über Ihre Meinung freuen.",
  ...
  nl: {
    ...
    reviewsSubtitle: "We zijn net begonnen - echte reviews van onze passagiers verschijnen hier binnenkort.",
    reviewsPlaceholderText: "Al eens met ons meegereden? We horen graag hoe je rit was.",
  ...
  it: {
    ...
    reviewsSubtitle: "Siamo appena agli inizi - presto qui appariranno recensioni reali dei nostri passeggeri.",
    reviewsPlaceholderText: "Sei già stato un nostro passeggero? Ci piacerebbe sapere com'è andato il tuo viaggio.",
